...
body{
	 background-image:url("resources/images/556.jpg");
...
<body>
 ...
 <!---heading---->
    ...
    <form class="form-horizontal" action="<c:url value="/addregister"/>" method="post"> 
	...
	<div class="row ">
     ...
     <!-----For email---->
		 <div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="emailId" >EmailId :</label></div>
			     <div class="col-xs-8"	>	 
			          <input type="emailId" name="emailId"  id="emailId"placeholder="Enter your emailId" class="form-control" >
		         </div>
		     </div>
		 </div>
	 <!-----For Password and confirm password---->
          <div class="col-sm-12">
		   ...
		   <div class="col-sm-12">
		         <div class="row">
				     <div class="col-xs-4">
		 	              <label class="mobileno">Password :</label></div>
				  <div class="col-xs-8">
			             <input type="mobileno" name="mobileno" id="mobileno" placeholder="Enter your Mobileno" class="form-control">
				 </div>
          </div>
		  </div>
		   ...
		   <div class="col-sm-12">
		         <div class="row">
				  ...
				  <div class="col-xs-8">
			             <input type="address" name="address" id="address" placeholder="Enter your Address" class="form-control">
				 </div>
          </div>
		  </div>
